...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            return new SignupView(clearController, signupController, signupViewModel);
        } catch (IOException e) {
    ...
    private static ClearController createClearUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface clearDataAccessObject) {
